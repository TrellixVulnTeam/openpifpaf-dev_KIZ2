...
from openpifpaf.network.losses import components
from openpifpaf.network.losses.composite import CompositeLoss, CompositeLossByComponent
from openpifpaf.network.losses.multi_head import MultiHeadLoss, MultiHeadLossAutoTuneKendall, MultiHeadLossAutoTuneVariance
