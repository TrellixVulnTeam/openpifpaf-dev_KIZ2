...
from openpifpaf.plugins.apollocar3d.constants import get_constants, training_weights_local_centrality
from openpifpaf.plugins.apollocar3d.metrics import MeanPixelError
