...
from openpifpaf.plugins.apollocar3d.constants import CAR_KEYPOINTS_24, CAR_SKELETON_24,\
    CAR_KEYPOINTS_66, CAR_SKELETON_66, KPS_MAPPING
from openpifpaf.plugins.apollocar3d.transforms import skeleton_mapping
